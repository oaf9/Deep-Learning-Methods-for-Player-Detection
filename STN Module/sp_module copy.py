...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.Conv3 = nn.Conv2d(32, 8, kernel_size = 4, padding = 2)
        ...
        self.dense_1 = nn.Linear(800, 50)
        self.dense_2 = nn.Linear(50, 57)
    ...
    def spt_forward(self, X):
        ...
        grid = F.affine_grid(Θ, torch.Size([X.size()[0], X.size()[1], 80, 80])) # downsampling from 128x128 to 28x28
